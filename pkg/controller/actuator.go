...
import (
	gvisorv1alpha1 "github.com/gardener/gardener-extension-provider-gcp/pkg/apis/gvisor/v1alpha1"
...
var (
	// StatusTypeMeta is the TypeMeta of GVisor Status
	StatusTypeMeta = metav1.TypeMeta{
		APIVersion: gvisorv1alpha1.SchemeGroupVersion.String(),
		Kind:       "RuntimeStatus",
	}
)
